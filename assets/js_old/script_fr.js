...
const textualvariations = [
  { label: "ia", titleX: "En tant que développeur, ce que j'offre dans le domaine de la science des données:", descriptionX: "Outils et perspectives en intelligence artificielle.", points: ["ML models", "Agents mutliples (projet)", "Vision APIs (projet)"], variation: ["Mise en œuvre d'analyses prédictives par des méthodes telles que le clustering, la régression, les modèles de classification et l'ACP intégrés dans des applications concrètes. J'utilise TensorFlow ou scikit-learn.", "Déploiement et intégration de chatbots/agents IA pour une automatisation optimale.", "Implémentation de la détection d'objets et de la classification d'images pour des fonctionnalités avancées dans les applications, en exploitant des technologies comme Google Cloud Vision ou OpenCV."]},
  { label: "bff", titleX: "En tant que spécialiste suisse en finance avec brevet fédéral, ce que j'offre:", descriptionX:"Services financiers et de management.", points: ["Management financier", "Soutiens aux décisions stratégiques", "Actionnaires"], variation: ["Budgétisation et prévision, reporting financier et gestion de la conformité (SCI, juridique, fiscal, réglementaire). Gestion de la trésorerie et des liquidités par l'optimisation du fonds de roulement.", "Planification stratégique avec des insights financiers et un support analytique. Suivi de la performance commerciale par l'analyse des KPI. Gestion et atténuation complètes des risques.", "Communication claire avec les investisseurs et les membres du conseil d'administration. Maintien de la confiance et de la transparence avec les auditeurs et les organismes de réglementation. Optimisation stratégique des structures de capital."]},
  { label: "bfc", titleX: "En tant que spécialiste suisse en comptabilité avec brevet fédéral, ce que j'offre:", descriptionX:"Services comptables.", points: ["Clôture et Reporting mensuel/trimestriel/annuel", "Salaires et déclaration aux ass. sociales", "Taxes directes et indirectes", "Consolidation et Comptabilité analytique d'exploitation"], variation: ["Expertise en droit des obligations et Swiss GAAP RPC, tableaux de flux de trésorerie, comptabilisation des transitoires, amortissements, dépréciations et provisions. Comptabilité des stocks utilisant les méthodes FIFO, LIFO et du coût moyen pondéré. Comptabilité des titres.", "Gestion complète de la paie comprenant le traitement des salaires, fiches de paie et certificats. Gestion des réconciliations de fin d'année pour les assurances sociales et déclarations finales.", "Fiscalité des personnes morales et indépendants. Gestion de la TVA (déclaration trimestrielle ou méthode de la dette fiscale nette semestrielle).", "Expertise en consolidation de groupe. Mise en œuvre des méthodes des coûts complets ou des coûts standards pour le controlling."]},
  { label: "data", titleX: "En tant que développeur, ce que j'offre en gestion et analyse de données:", descriptionX:"Extraction, nettoyage et visualisation des données.", points: ["Traitement de bases de données", "Exploration & Visualisation"], variation: ["Intégration de données via API, bases de données et systèmes de fichiers. Assurance du stockage et de la disponibilité des données par data lake, NoSQL et bases de données relationnelles. Traitement des données via ETL/ELT et pipelines automatisés pour les mises à jour en temps réel.", "Prétraitement des données pour assurer la qualité et faciliter l'analyse. Modélisation statistique et développement de visualisations et tableaux de bord intuitifs et informatifs avec Power BI, Plotly, Streamlit, Chart.js ou Excel."]},
  { label: "web", titleX: "En tant que full stack web développeur, ce que j'offre:", descriptionX: "Programmation et automatisation web.", points: ["Agile", "Frontend/Backend", "Déploiement/Maintenance"], variation: ["Utilisation de GitHub dans le cadre Scrum, en employant les 'Issues' comme 'User Stories', les 'Milestones' comme 'Sprints' et les 'Projects' pour suivre les processus et effectuer des revues de travail régulières.", "Compétence en développement HTML/CSS/JavaScript avec focus sur le design responsive, aussi en utilisant Bootstrap et autres frameworks CSS. Mise en œuvre de l'optimisation SEO et du référencement pour une visibilité améliorée. Optimisation des performances incluant l'implémentation des formats WebP ou AVIF. Spécialisation en Django et PostgreSQL.", "Capacité à déployer et maintenir des applications web dans divers environnements d'hébergement."]}
];
