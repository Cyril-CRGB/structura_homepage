...
const textualvariations = [
  { label: "ki", titleX: "Als Entwickler, was ich im Bereich Data Science anbiete:", descriptionX: "Künstliche Intelligenz für Finanzen.", points: ["ML models", "Multi-agent systems (Projekt)", "Vision APIs (Projekt)"], variation: ["Implementierung von Predictive Analytics durch Methoden wie Clustering, Regression, Klassifikationsmodelle und PCA, integriert in praxisnahe Anwendungen. Ich verwende TensorFlow oder scikit-learn Frameworks.", "Einsatz und Einbettung von Chatbots/KI-Agenten für optimale Automatisierung.", "Implementierung von Objekterkennung und Bildklassifizierung für erweiterte Anwendungsfunktionen unter Nutzung von Technologien wie Google Cloud Vision oder OpenCV."]},
  { label: "fff", titleX: "Als schweizerischer Fachmann mit eidgenössischen Fachausweis in Finanzen, was ich anbiete:", descriptionX:"Finanz- und Managementdienstleistungen.", points: ["Finanzmanagement", "Unterstützung bei strategischen Entscheidungen", "Aktionären"], variation: ["Budgetierung und Prognose, Finanzberichterstattung und Compliance-Management (IKS, rechtlich, steuerlich, regulatorisch). Cash- und Liquiditätsmanagement durch Optimierung des Working Capitals.", "Strategische Planung mit Finanzeinblicken und analytischer Unterstützung. Überwachung der Geschäftsleistung durch KPI-Analyse. Umfassendes Risikomanagement und Risikominderung.", "Klare Kommunikation mit Investoren und Vorstandsmitgliedern. Aufrechterhaltung von Vertrauen und Transparenz gegenüber Wirtschaftsprüfern und Aufsichtsbehörden. Strategische Optimierung von Kapitalstrukturen."]},
  { label: "ffr", titleX: "Als schweizerischer Fachmann mit eidgenössischen Fachausweis in Rechnungswesen, was ich anbiete:", descriptionX:"Buchhaltungsdienstleistungen.", points: ["monat/quartal/jahres-abschluss & Berichterstattung", "Lohn- und Sozialversicherungen", "Direkte & indirekte Steuern", "Konsolidierung & Controlling"], variation: ["Expertise in Obligationenrecht und Swiss GAAP FER, Kapitalflussrechnungen, transitorische Aktiven und Passiven, Amortisationen, Abschreibungen und Rückstellungen. Lagerbuchhaltung mit FIFO, LIFO und gewichteter Durchschnittskostenmethode. Wertschriftbuchhaltung.", "Umfassendes Lohnmanagement einschließlich Lohnverarbeitung, Lohnabrechnungen und Lohnausweis. Verwaltung von Sozialversicherungsabschlüssen und Endabrechnungen.", "Besteuerung juristischer Personen und Mehrwertsteuer-Management (quartalsweise oder Nettomethode mit halbjährlicher Berichterstattung).", "Expertise in Konzernkonsolidierung. Implementierung von Vollkosten- oder Standardkostenmethoden für das Controlling."]},
  { label: "data", titleX: "Als Entwickler, was ich im Bereich Datenverwaltung und -analyse anbiete:", descriptionX:"Datenextraktion, Datenreinigung und Visualisierung.", points: ["Bearbeitung von Datenbanken", "Untersuchung & Visualisierung"], variation: ["Datenintegration über APIs, Datenbanken und Dateisysteme. Sicherstellung der Datenspeicherung und -verfügbarkeit durch Data Lakes, NoSQL und relationale Datenbanken. Datenverarbeitung mittels ETL/ELT und automatisierte Pipelines für Echtzeit-Updates.", "Datenvorverarbeitung zur Qualitätssicherung und Erleichterung der Analyse. Statistische Modellierung und Entwicklung intuitiver, informativer Visualisierungen und Dashboards mit Power BI, Plotly, Streamlit, Chart.js oder Excel."]},
  { label: "web", titleX: "Als Full Stack Webentwickler, was ich anbiete:", descriptionX: "Web-Programmierung und -Automatisierung.", points: ["Agile", "Frontend/Backend", "Bereitstellung/Wartung"], variation: ["Nutzung von GitHub im Scrum-Framework, wobei 'Issues' als 'User Stories', 'Milestones' als 'Sprints' und 'Projects' zur Prozessverfolgung und regelmäßigen Arbeitsüberprüfung eingesetzt werden.", "Kompetenz in HTML/CSS/JavaScript-Entwicklung mit Fokus auf vollständige Responsivität, auch Verwendung von Bootstrap und anderen CSS-Frameworks. Implementierung von SEO-Optimierung und Referenzierung für verbesserte Sichtbarkeit. Leistungsoptimierung einschließlich WebP- oder AVIF-Format-Implementierung. Spezialisierung auf Django und PostgreSQL.", "Fähigkeit zur Bereitstellung und Wartung von Webanwendungen in verschiedenen Hosting-Umgebungen."]}
];
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const addSvgElements = () => {
    ...
    const contactText = createSvgText(100, 180, "Wie kann ich helfen?");
  ...
  function showContactForm() {
    ...
    form.innerHTML = `
      <div class="form-container">
        ...
        <div class="form-actions">
          ...
          <button type="button" class="close-form">Schließen</button>
        </div>
      </div>
    `;
    ...
    form.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        form.innerHTML = `
          <div class="form-container">
            <p>Danke für die Kontaktaufnahme!</p>
            <p>Ich werde innerhalb von 2 Stunden antworten.</p>
            <p>Bis gleich.</p>
            <div class="form-actions">
              <button type="button" class="close-form">Schließen</button>
            </div>
        ...
        form.innerHTML = `
          <div class="form-container">
            <p>Etwas ist schief gelaufen. Bitte versuchen Sie es später noch einmal.</p>
            <div class="form-actions">
              <button type="button" class="close-form">Schließen</button>
            </div>
          </div>
